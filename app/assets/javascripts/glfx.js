...
var fx = function () {
    ...
    (function () {
        ...
        try {
            var g = document.createElement("canvas").getContext("experimental-webgl", {preserveDrawingBuffer: true})
        } catch (l) {
        }
    ...
    v.canvas = function () {
        ...
        try {
            a = b.getContext("experimental-webgl", {premultipliedAlpha: !1, preserveDrawingBuffer: true})
        } catch (d) {
            a = null
        }
